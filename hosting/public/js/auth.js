...
function updateUserName() {
  var currentUserName = userName.getElementsByTagName('span')[0].innerHTML;
  var newUserName = prompt('Informe um novo nome de usuário.', currentUserName)
  if (newUserName && newUserName != '') 
  {
    userName.getElementsByTagName('span')[0].innerHTML = newUserName
    showItem(loading)
